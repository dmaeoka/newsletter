define(function() {
    return (opt = {}) => {
      ...
      .divider {
        ...
        let clientsTable = 
        `<table class="client-updates--table">
            <tr class="client-updates--row">
                <td class="client-updates--logo-cell">
                    <img 
                    alt="Motability"
                ...
                <td class="client-updates--description">
                    ...
                    <p class="client-updates--p">insert text here</p>
                </td>
            </tr>
        </table>`;

        bm.add('client-updates', {
            label: opt.clientUpdatesLabel,
            category: opt.categoryLabel,
            attributes: {
                class: 'gjs-fonts gjs-f-b1'
            },
        ...
        <tr>
            <td class="gray-bg">
                <table class="paulina-marketing inner-table">
                    <tr class="paulina-marketing--row">
                        <td class="paulina-marketing--cell">
                            <h1 class="title">
                                <img src="https://cdn2.hubspot.net/hubfs/2612720/Newsletter%20Assets/green_chevron.png"
                                    class="title--img"
                                    alt="" />
                                <span>TITLE</span>
                            </h1>
